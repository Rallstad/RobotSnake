...
;//! \htmlinclude SnakePose.msg.html

(cl:defclass <SnakePose> (roslisp-msg-protocol:ros-message)
  ((name
    :reader name
    :initarg :name
...
(cl:defclass SnakePose (<SnakePose>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SnakePose>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SnakePose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name snakebot_robot_pose-msg:<SnakePose> is deprecated: use snakebot_robot_pose-msg:SnakePose instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <SnakePose>))
...
(cl:defmethod number-val ((m <SnakePose>))
...
(cl:defmethod pose-val ((m <SnakePose>))
  ...
  (pose m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SnakePose>) ostream)
  "Serializes a message object of type '<SnakePose>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SnakePose>) istream)
  "Deserializes a message object of type '<SnakePose>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SnakePose>)))
  "Returns string type for a message object of type '<SnakePose>"
  "snakebot_robot_pose/SnakePose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SnakePose)))
  "Returns string type for a message object of type 'SnakePose"
  "snakebot_robot_pose/SnakePose")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SnakePose>)))
  "Returns md5sum for a message object of type '<SnakePose>"
  "342328e409d059b7deefb6a0a8b8c299")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SnakePose)))
  "Returns md5sum for a message object of type 'SnakePose"
  "342328e409d059b7deefb6a0a8b8c299")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SnakePose>)))
  "Returns full string definition for message of type '<SnakePose>"
  (cl:format cl:nil "string[] name                 # link names~%int32[] number								# link numbers~%geometry_msgs/Pose2D[] pose~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SnakePose)))
  "Returns full string definition for message of type 'SnakePose"
  (cl:format cl:nil "string[] name                 # link names~%int32[] number								# link numbers~%geometry_msgs/Pose2D[] pose~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SnakePose>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SnakePose>))
