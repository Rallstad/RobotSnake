...
"""autogenerated by genpy from snakebot_collisions/LinkContacts.msg. Do not edit."""
import sys
...
class LinkContacts(genpy.Message):
  _md5sum = "7fbb92d1b381927a81c6388ea406cd64"
  _type = "snakebot_collisions/LinkContacts"
...
float64 z
"""
  __slots__ = ['header','link','contact_sides','contact_normals','contact_tangents','contact_forces','contact_positions']
  _slot_types = ['std_msgs/Header','int32','string[]','geometry_msgs/Vector3[]','geometry_msgs/Vector3[]','geometry_msgs/Vector3[]','geometry_msgs/Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,link,contact_sides,contact_normals,contact_tangents,contact_forces,contact_positions
    ...
    """
    if args or kwds:
      super(LinkContacts, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.contact_tangents:
        _x = val1
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      length = len(self.contact_forces)
      buff.write(_struct_I.pack(length))
      for val1 in self.contact_forces:
        _x = val1
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.contact_forces.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.contact_positions = []
