// Generated by gencpp from file snakebot_matlab_communication/collisions.msg
// DO NOT EDIT!


#ifndef SNAKEBOT_MATLAB_COMMUNICATION_MESSAGE_COLLISIONS_H
#define SNAKEBOT_MATLAB_COMMUNICATION_MESSAGE_COLLISIONS_H
...
struct collisions_
{
  ...
  typedef boost::shared_ptr< ::snakebot_matlab_communication::collisions_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::snakebot_matlab_communication::collisions_<ContainerAllocator> const> ConstPtr;

}; // struct collisions_

typedef ::snakebot_matlab_communication::collisions_<std::allocator<void> > collisions;

typedef boost::shared_ptr< ::snakebot_matlab_communication::collisions > collisionsPtr;
typedef boost::shared_ptr< ::snakebot_matlab_communication::collisions const> collisionsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::snakebot_matlab_communication::collisions_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::snakebot_matlab_communication::collisions_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::snakebot_matlab_communication::collisions_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::snakebot_matlab_communication::collisions_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
{
  ...
  static const char* value(const ::snakebot_matlab_communication::collisions_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe501bfb903e4dfcbULL;
  static const uint64_t static_value2 = 0x8c45d45d37b998c0ULL;
};

template<class ContainerAllocator>
struct DataType< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
{
  static const char* value()
  {
    return "snakebot_matlab_communication/collisions";
  }
...
template<class ContainerAllocator>
struct Definition< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::snakebot_matlab_communication::collisions_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::snakebot_matlab_communication::collisions_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SNAKEBOT_MATLAB_COMMUNICATION_MESSAGE_COLLISIONS_H
